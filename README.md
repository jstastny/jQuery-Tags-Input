...
You can add extra HTML attributes to the input field generated by TagsInput by passing 'extraAttrs' option.
For example to use Twitter Bootrap typeahead you can use:
